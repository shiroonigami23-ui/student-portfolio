...
export function render(data) {
    ...
    <div class="portfolio-template classic">
        <aside class="sidebar">
            ...
            ${renderSection('Skills', data.skills, skill => `<li><strong>${escapeHtml(skill.name)}</strong><br>${escapeHtml(skill.level)}</li>`, '<ul>', '</ul>')}
        </aside>
        ...
        <main class="main-content">
            ...
            ${renderSection('Work Experience', data.experience, exp => `
                <div class="item">
                    <h4>${escapeHtml(exp.title)} at ${escapeHtml(exp.company)}</h4>
